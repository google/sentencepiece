 ...
 * @param T [0..n-1] The input string set using 0 as separators (T[n-1] must be
 * 0).
 * @param SA [0..n-1+fs] The output array of suffixes.
...
/**
 * Constructs the generalized suffix array (GSA) of given string set using
 * libsais context.
 * @param ctx The libsais context.
 * @param T [0..n-1] The input string set using 0 as separators (T[n-1] must be
 * 0).
...
/**
 * Constructs the generalized suffix array (GSA) of given string set in parallel
 * using OpenMP.
 * @param T [0..n-1] The input string set using 0 as separators (T[n-1] must be
 * 0).
 * @param SA [0..n-1+fs] The output array of suffixes.
...
/**
 * Constructs the permuted longest common prefix array (PLCP) of a given string
 * set and a generalized suffix array (GSA).
 * @param T [0..n-1] The input string set using 0 as separators (T[n-1] must be
 * 0).
...
/**
 * Constructs the permuted longest common prefix array (PLCP) of a integer array
 * and a suffix array.
 * @param T [0..n-1] The input integer array.
 * @param SA [0..n-1] The input suffix array.
 * @param PLCP [0..n-1] The output permuted longest common prefix array.
...
/**
 * Constructs the permuted longest common prefix array (PLCP) of a given string
 * set and a generalized suffix array (GSA) in parallel using OpenMP.
 * @param T [0..n-1] The input string set using 0 as separators (T[n-1] must be
 * 0).
 * @param SA [0..n-1] The input generalized suffix array.
 * @param PLCP [0..n-1] The output permuted longest common prefix array.
...
/**
 * Constructs the permuted longest common prefix array (PLCP) of a given integer
 * array and a suffix array in parallel using OpenMP.
 * @param T [0..n-1] The input integer array.
 * @param SA [0..n-1] The input suffix array.
 * @param PLCP [0..n-1] The output permuted longest common prefix array.
 * @param n The length of the integer array and the suffix array.
