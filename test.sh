...
run_docker() {
  docker pull "$1"
  docker run -e COVERALLS_REPO_TOKEN=CBcfEyG2o2UcCS9YKkNlX1OubIn2qPsKD --rm -ti --name travis-ci -v `pwd`:/sentencepiece -w /sentencepiece -td "$1" /bin/bash
