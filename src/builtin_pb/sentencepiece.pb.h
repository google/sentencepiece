...
class SentencePieceText_SentencePiece PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_surface();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
...
inline std::string* SentencePieceText_SentencePiece::unsafe_arena_release_piece() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sentencepiece.SentencePieceText.SentencePiece.piece)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return piece_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SentencePieceText_SentencePiece::unsafe_arena_set_allocated_piece(
    std::string* piece) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (piece != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  piece_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      piece, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sentencepiece.SentencePieceText.SentencePiece.piece)
}
...
inline void SentencePieceText_SentencePiece::clear_surface() {
  surface_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void SentencePieceText_SentencePiece::_internal_set_surface(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  surface_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void SentencePieceText_SentencePiece::set_surface(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  surface_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void SentencePieceText_SentencePiece::set_surface(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  surface_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SentencePieceText_SentencePiece::_internal_mutable_surface() {
  _has_bits_[0] |= 0x00000002u;
  return surface_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* SentencePieceText_SentencePiece::unsafe_arena_release_surface() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sentencepiece.SentencePieceText.SentencePiece.surface)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return surface_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SentencePieceText_SentencePiece::unsafe_arena_set_allocated_surface(
    std::string* surface) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (surface != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  surface_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      surface, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sentencepiece.SentencePieceText.SentencePiece.surface)
}
...
inline std::string* SentencePieceText::unsafe_arena_release_text() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sentencepiece.SentencePieceText.text)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return text_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SentencePieceText::unsafe_arena_set_allocated_text(
    std::string* text) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (text != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  text_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      text, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sentencepiece.SentencePieceText.text)
}
