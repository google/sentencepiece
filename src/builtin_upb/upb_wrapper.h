...
class ProtoStr : public absl::string_view {
 public:
  ...
  bool operator==(const std::string& other) const { return absl::string_view(*this) == other; }
  friend bool operator==(const std::string& a, const ProtoStr& b) { return a == absl::string_view(b); }
};
...
class SentencePieceText_SentencePiece {
 public:
  SentencePieceText_SentencePiece(upb::SentencePieceTextWrapper* parent, int index)
      : parent_(parent), index_(index) {}
...
class RepeatedStringWrapper {
 public:
  RepeatedStringWrapper(const upb_StringView* arr, size_t size) : arr_(arr), size_(size) {}
  ...
  class Iterator {
   public:
    ...
    Iterator(const upb_StringView* arr, size_t index) : arr_(arr), index_(index) {}
    Iterator& operator++() { ++index_; return *this; }
    Iterator operator++(int) { Iterator tmp = *this; ++index_; return tmp; }
    bool operator==(const Iterator& other) const { return index_ == other.index_; }
    bool operator!=(const Iterator& other) const { return index_ != other.index_; }
    ProtoStr operator*() const {
      return ProtoStr(arr_[index_]);
    }
   private:
...
#define DEFINE_UPB_PRIMITIVE_ACCESSOR(FieldName, Type, DefaultVal, UpbPrefix) \
  Type FieldName() const { return msg_ ? UpbPrefix##_##FieldName(msg_) : DefaultVal; } \
...
#define DEFINE_UPB_STRING_ACCESSOR(FieldName, DefaultVal, UpbPrefix) \
  ...
  void set_##FieldName(absl::string_view val) { \
    if (msg_ && arena_) { \
      upb_StringView sv; \
      char* ptr = (char*)upb_Arena_Malloc(arena_, val.size()); \
      memcpy(ptr, val.data(), val.size()); \
      sv.data = ptr; \
      sv.size = val.size(); \
      UpbPrefix##_set_##FieldName(msg_, sv); \
    } \
  } \
...
#define DEFINE_UPB_HAS_FIELD_ACCESSOR(FieldName, UpbPrefix) \
  bool has_##FieldName() const { return msg_ && UpbPrefix##_has_##FieldName(msg_); }

#define DEFINE_UPB_ENUM_ACCESSOR(FieldName, EnumType, DefaultVal, UpbPrefix) \
  EnumType FieldName() const { \
    return msg_ ? static_cast<EnumType>(UpbPrefix##_##FieldName(msg_)) : DefaultVal; \
  } \
...
#define DEFINE_UPB_REPEATED_STRING_ACCESSOR(FieldName, UpbPrefix) \
  ...
  void add_##FieldName(const std::string& val) { \
    if (msg_ && arena_) { \
      ...
      sv.data = ptr; \
      sv.size = val.size(); \
      UpbPrefix##_add_##FieldName(msg_, sv, arena_); \
    } \
  } \
  void clear_##FieldName() { \
    if (msg_) { \
...
class TrainerSpecWrapper {
 ...
 public:
  ...
  explicit TrainerSpecWrapper(const sentencepiece_TrainerSpec* msg, upb_Arena* arena = nullptr)
      : msg_(const_cast<sentencepiece_TrainerSpec*>(msg)), arena_(arena), owns_msg_(false) {}

  TrainerSpecWrapper(const sentencepiece_TrainerSpec* msg, upb_Arena* arena,
                      std::function<void(const sentencepiece_TrainerSpec*)> on_change)
      : msg_(const_cast<sentencepiece_TrainerSpec*>(msg)), arena_(arena), owns_msg_(false), on_change_(on_change) {}
  
  TrainerSpecWrapper(const TrainerSpecWrapper& other) : arena_(upb_Arena_New()), owns_msg_(true) {
    msg_ = sentencepiece_TrainerSpec_new(arena_);
    CopyFrom(other);
  }
    ...
    if (this != &other) {
      if (owns_msg_) {
        ...
        if (other.msg_) {
          size_t size = 0;
          upb_Arena* tmp_arena = upb_Arena_New();
          char* buf = sentencepiece_TrainerSpec_serialize(other.msg_, tmp_arena, &size);
          if (buf) {
  ...
  DEFINE_UPB_SERIALIZATION_METHODS(TrainerSpecWrapper, sentencepiece_TrainerSpec)
  ...
  DEFINE_UPB_ENUM_ACCESSOR(model_type, ModelType, UNIGRAM, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(vocab_size, int32_t, 8000, sentencepiece_TrainerSpec)
  DEFINE_UPB_REPEATED_STRING_ACCESSOR(accept_language, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(self_test_sample_size, int32_t, 0, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(enable_differential_privacy, bool, false, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(differential_privacy_noise_level, float, 0.0f, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(differential_privacy_clipping_threshold, uint64_t, 0, sentencepiece_TrainerSpec)
  
  DEFINE_UPB_PRIMITIVE_ACCESSOR(character_coverage, float, 0.9995f, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(input_sentence_size, uint64_t, 0, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(shuffle_input_sentence, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(seed_sentencepiece_size, int32_t, 1000000, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(shrinking_factor, float, 0.75f, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(max_sentence_length, int32_t, 4192, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(num_threads, int32_t, 16, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(num_sub_iterations, int32_t, 2, sentencepiece_TrainerSpec)
  
  DEFINE_UPB_PRIMITIVE_ACCESSOR(max_sentencepiece_length, int32_t, 16, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(split_by_unicode_script, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(split_by_number, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(split_by_whitespace, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(treat_whitespace_as_suffix, bool, false, sentencepiece_TrainerSpec)
  ...
  DEFINE_UPB_STRING_ACCESSOR(pretokenization_delimiter, "", sentencepiece_TrainerSpec)
  
  DEFINE_UPB_REPEATED_STRING_ACCESSOR(control_symbols, sentencepiece_TrainerSpec)
  DEFINE_UPB_REPEATED_STRING_ACCESSOR(user_defined_symbols, sentencepiece_TrainerSpec)
  ...
  DEFINE_UPB_PRIMITIVE_ACCESSOR(vocabulary_output_piece_score, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(hard_vocab_limit, bool, true, sentencepiece_TrainerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(use_all_vocab, bool, false, sentencepiece_TrainerSpec)
  ...
  DEFINE_UPB_STRING_ACCESSOR(unk_surface, " \xE2\x81\x87 ", sentencepiece_TrainerSpec)
  
  DEFINE_UPB_PRIMITIVE_ACCESSOR(train_extremely_large_corpus, bool, false, sentencepiece_TrainerSpec)
  DEFINE_UPB_STRING_ACCESSOR(seed_sentencepieces_file, "", sentencepiece_TrainerSpec)
...
class NormalizerSpecWrapper {
 ...
 public:
  ...
  explicit NormalizerSpecWrapper(const sentencepiece_NormalizerSpec* msg, upb_Arena* arena = nullptr)
      : msg_(const_cast<sentencepiece_NormalizerSpec*>(msg)), arena_(arena), owns_msg_(false) {}

  NormalizerSpecWrapper(const sentencepiece_NormalizerSpec* msg, upb_Arena* arena,
                        std::function<void(const sentencepiece_NormalizerSpec*)> on_change)
      : msg_(const_cast<sentencepiece_NormalizerSpec*>(msg)), arena_(arena), owns_msg_(false), on_change_(on_change) {}
  
  NormalizerSpecWrapper(const NormalizerSpecWrapper& other) : arena_(upb_Arena_New()), owns_msg_(true) {
    msg_ = sentencepiece_NormalizerSpec_new(arena_);
    CopyFrom(other);
  }
    ...
    if (this != &other) {
      if (owns_msg_) {
        ...
        if (other.msg_) {
          size_t size = 0;
          upb_Arena* tmp_arena = upb_Arena_New();
          char* buf = sentencepiece_NormalizerSpec_serialize(other.msg_, tmp_arena, &size);
          if (buf) {
  ...
  DEFINE_UPB_SERIALIZATION_METHODS(NormalizerSpecWrapper, sentencepiece_NormalizerSpec)

  void OnArenaReset() {}

  DEFINE_UPB_STRING_ACCESSOR(name, "", sentencepiece_NormalizerSpec)
  DEFINE_UPB_STRING_ACCESSOR(precompiled_charsmap, "", sentencepiece_NormalizerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(add_dummy_prefix, bool, true, sentencepiece_NormalizerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(remove_extra_whitespaces, bool, true, sentencepiece_NormalizerSpec)
  DEFINE_UPB_PRIMITIVE_ACCESSOR(escape_whitespaces, bool, true, sentencepiece_NormalizerSpec)
  DEFINE_UPB_STRING_ACCESSOR(normalization_rule_tsv, "", sentencepiece_NormalizerSpec)
...
class SelfTestData_SampleWrapper {
 public:
  explicit SelfTestData_SampleWrapper(const sentencepiece_SelfTestData_Sample* msg)
      : msg_(msg), mutable_msg_(nullptr), arena_(nullptr) {}
  SelfTestData_SampleWrapper(sentencepiece_SelfTestData_Sample* msg, upb_Arena* arena)
  ...
  ProtoStr expected() const {
    if (!msg_ || !sentencepiece_SelfTestData_Sample_has_expected(msg_)) return "";
  ...
  void set_input(const std::string& val) {
    if (mutable_msg_ && arena_) {
      ...
      sv.data = ptr;
      sv.size = val.size();
      sentencepiece_SelfTestData_Sample_set_input(mutable_msg_, sv);
    }
  }
  void set_expected(const std::string& val) {
    if (mutable_msg_ && arena_) {
      ...
      sv.data = ptr;
      sv.size = val.size();
      sentencepiece_SelfTestData_Sample_set_expected(mutable_msg_, sv);
    }
  }
 private:
...
class SelfTestDataWrapper {
 public:
  ...
  class SamplesRepeatedWrapper {
   public:
    SamplesRepeatedWrapper(const sentencepiece_SelfTestData_Sample* const* elements, size_t count)
    ...
    class Iterator {
     public:
      ...
      Iterator(const sentencepiece_SelfTestData_Sample* const* elements, size_t index) : elements_(elements), index_(index) {}
      Iterator& operator++() { ++index_; return *this; }
      Iterator operator++(int) { Iterator tmp = *this; ++index_; return tmp; }
      bool operator==(const Iterator& other) const { return index_ == other.index_; }
      bool operator!=(const Iterator& other) const { return index_ != other.index_; }
  ...
  SelfTestData_SampleWrapper* add_samples() {
    if (mutable_msg_ && arena_) {
      ...
      size_t size;
      sentencepiece_SelfTestData_Sample** samples = sentencepiece_SelfTestData_mutable_samples(mutable_msg_, &size);
      sample_wrappers_[new_index] = std::make_unique<SelfTestData_SampleWrapper>(samples[new_index], arena_);
 ...
 private:
  ...
  upb_Arena* arena_;
  mutable std::vector<std::unique_ptr<SelfTestData_SampleWrapper>> sample_wrappers_;
};
...
class ModelProtoWrapper {
 public:
  ...
  explicit ModelProtoWrapper(const sentencepiece_ModelProto* msg, upb_Arena* arena)
      : msg_(const_cast<sentencepiece_ModelProto*>(msg)), arena_(arena), owns_msg_(false) {}
  ...
  inline ::sentencepiece::ModelProto_SentencePiece pieces(int index) const {
    return ::sentencepiece::ModelProto_SentencePiece(const_cast<ModelProtoWrapper*>(this), index);
  }
   ...
   public:
    ...
    class Iterator {
     public:
      ...
      Iterator(const ModelProtoWrapper* parent, int index) : parent_(parent), index_(index) {}
      ModelProto_SentencePiece operator*() const {
        return ModelProto_SentencePiece(const_cast<ModelProtoWrapper*>(parent_), index_);
      }
      Iterator& operator++() { ++index_; return *this; }
      bool operator!=(const Iterator& other) const { return index_ != other.index_; }
     private:
  ...
  PiecesRepeatedWrapper pieces() const {
    return PiecesRepeatedWrapper(this);
  }
   ...
   public:
    ...
    class Iterator {
     public:
      ...
      Iterator(ModelProtoWrapper* parent, int index) : parent_(parent), index_(index) {}
      ModelProto_SentencePiece& operator*() const {
      ...
      friend Iterator operator-(Iterator it, difference_type n) { it -= n; return it; }
      friend difference_type operator-(const Iterator& a, const Iterator& b) { return a.index_ - b.index_; }
      
      ModelProto_SentencePiece& operator[](difference_type n) const { return *(parent_->mutable_pieces(index_ + n)); }
      
      bool operator==(const Iterator& other) const { return index_ == other.index_ && parent_ == other.parent_; }
    ...
    int size() const { return parent_->pieces_size(); }
    ModelProto_SentencePiece* Mutable(int index) { return parent_->mutable_pieces(index); }
   private:
    ModelProtoWrapper* parent_;
  };
  ...
  MutablePiecesRepeatedWrapper* mutable_pieces() {
    if (!mutable_pieces_wrapper_) {
      mutable_pieces_wrapper_ = std::make_unique<MutablePiecesRepeatedWrapper>(this);
    }
  ...
  ProtoStr piece_at(int index) const {
    size_t size = 0;
    const sentencepiece_ModelProto_SentencePiece* const* pieces = sentencepiece_ModelProto_pieces(msg_, &size);
    if (index < 0 || static_cast<size_t>(index) >= size) return "";
    return ProtoStr(sentencepiece_ModelProto_SentencePiece_piece(pieces[index]));
  }
  ...
  void set_type_at(int index, int type) {
    if (msg_) {
      size_t size = 0;
      sentencepiece_ModelProto_SentencePiece** pieces = sentencepiece_ModelProto_mutable_pieces(msg_, &size);
      sentencepiece_ModelProto_SentencePiece_set_type(pieces[index], static_cast<sentencepiece_ModelProto_SentencePiece_Type>(type));
    }
  }
  void set_piece_at(int index, absl::string_view piece) {
    if (msg_) {
      ...
      sentencepiece_ModelProto_SentencePiece** pieces = sentencepiece_ModelProto_mutable_pieces(msg_, &size);
      upb_StringView sv;
      char* ptr = (char*)upb_Arena_Malloc(arena_, piece.size());
      memcpy(ptr, piece.data(), piece.size());
      sv.data = ptr;
      sv.size = piece.size();
      sentencepiece_ModelProto_SentencePiece_set_piece(pieces[index], sv);
    }
  }
    ...
    if (piece_wrappers_.size() != pieces_size()) {
      ...
      for (int i = 0; i < pieces_size(); ++i) {
        if (!piece_wrappers_[i]) {
          piece_wrappers_[i] = std::make_unique<ModelProto_SentencePiece>(this, i);
        }
      }
    }
  }
...
class SentencePieceTextWrapper {
 public:
  ...
  SentencePieceTextWrapper(const SentencePieceTextWrapper& other) : SentencePieceTextWrapper() {
    CopyFrom(other);
  }
  ...
  DEFINE_UPB_SERIALIZATION_METHODS(SentencePieceTextWrapper, sentencepiece_SentencePieceText)
  ...
  void set_text(absl::string_view text) {
    upb_StringView sv;
    char* ptr = (char*)upb_Arena_Malloc(arena(), text.size());
    memcpy(ptr, text.data(), text.size());
    sv.data = ptr;
    sv.size = text.size();
    sentencepiece_SentencePieceText_set_text(mutable_msg(), sv);
  }
  void set_text(const char* data, size_t size) {
    set_text(absl::string_view(data, size));
  }

  float score() const { return msg() ? sentencepiece_SentencePieceText_score(msg()) : 0.0; }
  void set_score(float score) { sentencepiece_SentencePieceText_set_score(mutable_msg(), score); }
  ...
  SentencePieceText_SentencePiece* add_pieces() {
    ...
    auto wrapper = std::make_unique<SentencePieceText_SentencePiece>(this, index);
  ...
  class ConstPiecesRepeatedWrapper {
   public:
    ConstPiecesRepeatedWrapper(const SentencePieceTextWrapper* parent) : parent_(parent) {}
    class Iterator {
     public:
      using iterator_category = std::forward_iterator_tag;
      ...
      Iterator(const SentencePieceTextWrapper* parent, int index) : parent_(parent), index_(index) {}
      SentencePieceText_SentencePiece& operator*() const {
        return *(const_cast<SentencePieceTextWrapper*>(parent_)->mutable_pieces(index_));
      }
      Iterator& operator++() { ++index_; return *this; }
      bool operator!=(const Iterator& other) const { return index_ != other.index_; }
     private:
  ...
  class MutablePiecesRepeatedWrapper {
   public:
    MutablePiecesRepeatedWrapper(SentencePieceTextWrapper* parent) : parent_(parent) {}
    class Iterator {
     public:
      using iterator_category = std::random_access_iterator_tag;
      using value_type = SentencePieceText_SentencePiece;
      ...
      Iterator(SentencePieceTextWrapper* parent, int index) : parent_(parent), index_(index) {}
      ...
      SentencePieceText_SentencePiece& operator[](difference_type n) const { return *(parent_->mutable_pieces(index_ + n)); }
    ...
    SentencePieceText_SentencePiece* Mutable(int index) { return parent_->mutable_pieces(index); }
   private:
    SentencePieceTextWrapper* parent_;
  };
  ...
  absl::string_view piece_at(int index) const {
    ...
    upb_StringView sv = sentencepiece_SentencePieceText_SentencePiece_piece(pieces[index]);
    return absl::string_view(sv.data, sv.size);
  }
  
  void set_piece_at(int index, absl::string_view piece) {
    size_t size = 0;
    auto** pieces = sentencepiece_SentencePieceText_mutable_pieces(mutable_msg(), &size);
    upb_StringView sv;
    char* ptr = (char*)upb_Arena_Malloc(arena(), piece.size());
    memcpy(ptr, piece.data(), piece.size());
    sv.data = ptr;
    sv.size = piece.size();
    sentencepiece_SentencePieceText_SentencePiece_set_piece(pieces[index], sv);
  }
  ...
  absl::string_view surface_at(int index) const {
    ...
    const auto* pieces = sentencepiece_SentencePieceText_pieces(msg(), &size);
    if (index < 0 || index >= size) return "";
    upb_StringView sv = sentencepiece_SentencePieceText_SentencePiece_surface(pieces[index]);
    return absl::string_view(sv.data, sv.size);
  }
  void set_surface_at(int index, absl::string_view surface) {
    ...
    auto** pieces = sentencepiece_SentencePieceText_mutable_pieces(mutable_msg(), &size);
    upb_StringView sv;
    char* ptr = (char*)upb_Arena_Malloc(arena(), surface.size());
    memcpy(ptr, surface.data(), surface.size());
    sv.data = ptr;
    sv.size = surface.size();
    sentencepiece_SentencePieceText_SentencePiece_set_surface(pieces[index], sv);
  }
  ...
  void set_begin_at(int index, uint32_t begin) {
    size_t size = 0;
    auto** pieces = sentencepiece_SentencePieceText_mutable_pieces(mutable_msg(), &size);
    sentencepiece_SentencePieceText_SentencePiece_set_begin(pieces[index], begin);
  }
  ...
  void LazyInitPieceWrappersCache() const {
    if (piece_wrappers_.size() != pieces_size()) {
      ...
      for (int i = 0; i < pieces_size(); ++i) {
        if (!piece_wrappers_[i]) {
          piece_wrappers_[i] = std::make_unique<SentencePieceText_SentencePiece>(
 ...
 private:
  ...
  mutable std::vector<std::unique_ptr<SentencePieceText_SentencePiece>> piece_wrappers_;
  std::unique_ptr<MutablePiecesRepeatedWrapper> mutable_pieces_wrapper_;
};
...
class NBestSentencePieceTextWrapper {
 public:
  ...
  NBestSentencePieceTextWrapper(const NBestSentencePieceTextWrapper& other) : NBestSentencePieceTextWrapper() {
    CopyFrom(other);
  }
  NBestSentencePieceTextWrapper& operator=(const NBestSentencePieceTextWrapper& other) {
    if (this != &other) {
      Clear();
      CopyFrom(other);
    }
  ...
  DEFINE_UPB_SERIALIZATION_METHODS(NBestSentencePieceTextWrapper, sentencepiece_NBestSentencePieceText)
  ...
  virtual const sentencepiece_NBestSentencePieceText* msg() const { return msg_; }
  virtual upb_Arena* arena() { return arena_; }
  virtual const upb_Arena* arena() const { return arena_; }
  ...
  class ConstNbestsRepeatedWrapper {
   public:
    ConstNbestsRepeatedWrapper(const NBestSentencePieceTextWrapper* parent) : parent_(parent) {}
    class Iterator {
     public:
      using iterator_category = std::forward_iterator_tag;
      ...
      Iterator(const NBestSentencePieceTextWrapper* parent, int index) : parent_(parent), index_(index) {}
 ...
 protected:
  ...
  mutable std::vector<std::unique_ptr<NBestSentencePieceText_Sub>> nbest_wrappers_;
 private:
};
...
class NBestSentencePieceText_Sub : public SentencePieceText {
 public:
  NBestSentencePieceText_Sub(upb::NBestSentencePieceTextWrapper* parent, int index)
...
class NBestSentencePieceText : public sentencepiece::upb::NBestSentencePieceTextWrapper {
 public:
  ...
  class MutableNbestsRepeatedWrapper {
   public:
    MutableNbestsRepeatedWrapper(NBestSentencePieceText* parent) : parent_(parent) {}
    ...
    class Iterator {
     public:
      ...
      Iterator(NBestSentencePieceText* parent, int index) : parent_(parent), index_(index) {}
  ...
  MutableNbestsRepeatedWrapper* mutable_nbests() {
    if (!mutable_nbests_wrapper_) {
      mutable_nbests_wrapper_ = std::make_unique<MutableNbestsRepeatedWrapper>(this);
    }
...
inline float ModelProto_SentencePiece::score() const {
  return parent_->score_at(index_);
}
inline ModelProto_SentencePiece::Type ModelProto_SentencePiece::type() const {
  return static_cast<Type>(parent_->type_at(index_));
}
inline void ModelProto_SentencePiece::set_type(Type type) {
  parent_->set_type_at(index_, type);
}

inline TrainerSpec upb::ModelProtoWrapper::trainer_spec() const {
  return TrainerSpec(msg_ ? sentencepiece_ModelProto_trainer_spec(msg_) : nullptr, arena_);
}
inline const NormalizerSpec& upb::ModelProtoWrapper::normalizer_spec() const {
  if (!normalizer_spec_cache_) {
    normalizer_spec_cache_ = std::make_unique<NormalizerSpec>(
        msg_ ? sentencepiece_ModelProto_normalizer_spec(msg_) : nullptr, arena_);
  }
  return *normalizer_spec_cache_;
}
inline const NormalizerSpec& upb::ModelProtoWrapper::denormalizer_spec() const {
  if (!denormalizer_spec_cache_) {
    denormalizer_spec_cache_ = std::make_unique<NormalizerSpec>(
        msg_ ? sentencepiece_ModelProto_denormalizer_spec(msg_) : nullptr, arena_);
  }
  return *denormalizer_spec_cache_;
}
inline SelfTestData upb::ModelProtoWrapper::self_test_data() const {
  return SelfTestData(msg_ ? sentencepiece_ModelProto_self_test_data(msg_) : nullptr);
}

inline upb_Arena* NBestSentencePieceText_Sub::arena() { return parent_->arena(); }
inline const upb_Arena* NBestSentencePieceText_Sub::arena() const { return parent_->arena(); }
...
inline NBestSentencePieceText_Sub* upb::NBestSentencePieceTextWrapper::add_nbests() {
  ...
  auto wrapper = std::make_unique<NBestSentencePieceText_Sub>(
      this, index);
...
inline const NBestSentencePieceText_Sub& upb::NBestSentencePieceTextWrapper::nbests(int index) const {
...
inline const NBestSentencePieceText_Sub& upb::NBestSentencePieceTextWrapper::ConstNbestsRepeatedWrapper::Iterator::operator*() const {
  return parent_->nbests(index_);
}

inline sentencepiece_SentencePieceText* NBestSentencePieceText_Sub::mutable_msg() {
  size_t size = 0;
  sentencepiece_SentencePieceText** nbests =
      sentencepiece_NBestSentencePieceText_mutable_nbests(parent_->mutable_msg(), &size);
  return nbests[index_];
}
inline const sentencepiece_SentencePieceText* NBestSentencePieceText_Sub::msg() const {
  size_t size = 0;
...
inline void SentencePieceText_SentencePiece::set_piece(absl::string_view piece) {
  if (parent_) {
    parent_->set_piece_at(index_, piece);
  }
}
inline void SentencePieceText_SentencePiece::set_piece(const char* data, size_t size) {
  set_piece(absl::string_view(data, size));
}
...
inline void SentencePieceText_SentencePiece::set_surface(absl::string_view surface) {
  if (parent_) {
    parent_->set_surface_at(index_, surface);
  }
}
inline void SentencePieceText_SentencePiece::set_surface(const char* data, size_t size) {
...
inline void swap(SentencePieceText_SentencePiece a, SentencePieceText_SentencePiece b) {
  a.parent_->SwapElementsData(a.index_, b.index_);
}



inline const NBestSentencePieceText_Sub& NBestSentencePieceText::nbests(int index) const {
...
inline NBestSentencePieceText_Sub* NBestSentencePieceText::mutable_nbests_at(int index) {
  if (nbest_wrappers_.size() != nbests_size()) {
    nbest_wrappers_.resize(nbests_size());
    for (int i = 0; i < nbests_size(); ++i) {
      if (!nbest_wrappers_[i]) {
        nbest_wrappers_[i] = std::make_unique<NBestSentencePieceText_Sub>(this, i);
      }
    }
  }
...
inline ::sentencepiece::NormalizerSpec* upb::ModelProtoWrapper::mutable_normalizer_spec() const {
  if (!mutable_normalizer_spec_) {
    if (msg_) {
      sentencepiece_NormalizerSpec* sub_msg = sentencepiece_ModelProto_mutable_normalizer_spec(msg_, arena_);
      mutable_normalizer_spec_ = std::make_unique<::sentencepiece::NormalizerSpec>(
          sub_msg, arena_, [this](const sentencepiece_NormalizerSpec* new_sub_msg) {
            sentencepiece_ModelProto_set_normalizer_spec(
                this->msg_, const_cast<sentencepiece_NormalizerSpec*>(new_sub_msg));
            this->normalizer_spec_cache_.reset();
          });
    } else {
      mutable_normalizer_spec_ = std::make_unique<::sentencepiece::NormalizerSpec>(nullptr);
    }
  }
  return mutable_normalizer_spec_.get();
}

inline ::sentencepiece::NormalizerSpec* upb::ModelProtoWrapper::mutable_denormalizer_spec() const {
  if (!mutable_denormalizer_spec_) {
    if (msg_) {
      sentencepiece_NormalizerSpec* sub_msg = sentencepiece_ModelProto_mutable_denormalizer_spec(msg_, arena_);
      mutable_denormalizer_spec_ = std::make_unique<::sentencepiece::NormalizerSpec>(
          sub_msg, arena_, [this](const sentencepiece_NormalizerSpec* new_sub_msg) {
            sentencepiece_ModelProto_set_denormalizer_spec(
                this->msg_, const_cast<sentencepiece_NormalizerSpec*>(new_sub_msg));
            this->denormalizer_spec_cache_.reset();
          });
    } else {
      mutable_denormalizer_spec_ = std::make_unique<::sentencepiece::NormalizerSpec>(nullptr);
    }
  }
...
inline ModelProto_SentencePiece* ModelProto::add_pieces() {
  if (msg_) {
    ...
    piece_wrappers_.resize(pieces_size());
    piece_wrappers_[new_index] = std::make_unique<ModelProto_SentencePiece>(this, new_index);
    return piece_wrappers_[new_index].get();
  }
  return nullptr;
}

inline ::sentencepiece::TrainerSpec* upb::ModelProtoWrapper::mutable_trainer_spec() const {
  if (!mutable_trainer_spec_) {
    if (msg_) {
      sentencepiece_TrainerSpec* sub_msg = sentencepiece_ModelProto_mutable_trainer_spec(msg_, arena_);
      mutable_trainer_spec_ = std::make_unique<::sentencepiece::TrainerSpec>(
          sub_msg, arena_, [this](const sentencepiece_TrainerSpec* new_sub_msg) {
            sentencepiece_ModelProto_set_trainer_spec(
                this->msg_, const_cast<sentencepiece_TrainerSpec*>(new_sub_msg));
          });
    } else {
      mutable_trainer_spec_ = std::make_unique<::sentencepiece::TrainerSpec>(nullptr);
    }
  }
  return mutable_trainer_spec_.get();
}

inline ::sentencepiece::SelfTestData* upb::ModelProtoWrapper::mutable_self_test_data() const {
  if (!mutable_self_test_data_) {
    if (msg_) {
      sentencepiece_SelfTestData* sub_msg = sentencepiece_ModelProto_mutable_self_test_data(msg_, arena_);
      mutable_self_test_data_ = std::make_unique<::sentencepiece::SelfTestData>(sub_msg, arena_);
    } else {
      mutable_self_test_data_ = std::make_unique<::sentencepiece::SelfTestData>(nullptr, nullptr);
    }
  }
...
inline void upb::ModelProtoWrapper::set_trainer_spec(const TrainerSpec& spec) {
  if (msg_ && spec.msg_) {
    size_t size = 0;
    upb_Arena* tmp_arena = upb_Arena_New();
    char* buf = sentencepiece_TrainerSpec_serialize(spec.msg_, tmp_arena, &size);
    if (buf) {
      sentencepiece_TrainerSpec* sub_msg = sentencepiece_TrainerSpec_parse(buf, size, arena_);
      sentencepiece_ModelProto_set_trainer_spec(msg_, sub_msg);
      mutable_trainer_spec_ = std::make_unique<::sentencepiece::TrainerSpec>(sub_msg, arena_);
    }
    upb_Arena_Free(tmp_arena);
  }
}

inline void upb::ModelProtoWrapper::set_normalizer_spec(const NormalizerSpec& spec) {
  if (msg_ && spec.msg_) {
    size_t size = 0;
    upb_Arena* tmp_arena = upb_Arena_New();
    char* buf = sentencepiece_NormalizerSpec_serialize(spec.msg_, tmp_arena, &size);
    if (buf) {
      sentencepiece_NormalizerSpec* sub_msg = sentencepiece_NormalizerSpec_parse(buf, size, arena_);
      sentencepiece_ModelProto_set_normalizer_spec(msg_, sub_msg);
      normalizer_spec_cache_ = std::make_unique<::sentencepiece::NormalizerSpec>(sub_msg, arena_);
    }
    upb_Arena_Free(tmp_arena);
  }
}

inline void upb::ModelProtoWrapper::set_denormalizer_spec(const NormalizerSpec& spec) {
  if (msg_ && spec.msg_) {
    size_t size = 0;
    upb_Arena* tmp_arena = upb_Arena_New();
    char* buf = sentencepiece_NormalizerSpec_serialize(spec.msg_, tmp_arena, &size);
    if (buf) {
      ...
      mutable_denormalizer_spec_ = std::make_unique<::sentencepiece::NormalizerSpec>(sub_msg, arena_);
    }
    upb_Arena_Free(tmp_arena);
  }
}
